...
export const FAQS = [
  ...
  { id: 'faq2', question: '高级版有哪些功能？', answer: 'AI高级订阅可解锁：1) 高精度3.1-pro/image等大型会话模型；2) 拟真数字语音包（甜美少女 / 成熟御姐等专属配音）；3) 扩容世界书(Worldbook)条目至 10,000 字以上；4) 角色全息动态壁纸和自定义霓虹聊天泡沫颜色。' },
  { id: 'faq3', question: '如何修改角色声音？', answer: '在“创建角色”或“编辑角色”页面下拉找到【角色配音】选项，即可随意切换“甜美少女”或“成熟御姐”等专属的TTS音频配音。高级套餐还支持在对话中一键开启语音朗读。' }
];
