...
export default function EmailLoginScreen({ onNavigate, onLogin, onGoogleLogin }: EmailLoginScreenProps) {
      ...
      <main className="flex-1 flex flex-col items-center justify-center pt-24 pb-12 w-full max-w-md mx-auto z-10">
        ...
        <div className="flex gap-4 w-full mb-8">
           <button
            ...
            className="flex-1 bg-surface-elevated/40 py-3 rounded-xl flex items-center justify-center border border-outline-variant hover:bg-surface-elevated/60 transition-colors gap-2 cursor-pointer disabled:opacity-50"
          >
            ...
            <span className="text-xs font-semibold text-white">{googleLoading ? '连接中...' : 'Google'}</span>
          </button>
        </div>
