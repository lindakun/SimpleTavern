...
export default function WelcomeScreen({ onNavigate, onGoogleLogin }: WelcomeScreenProps) {
      ...
      <div className="flex flex-col justify-center items-center max-w-md mx-auto w-full relative z-10 gap-4 my-2">
        ...
        <div className="w-full space-y-4">
          ...
          <button
            ...
            className="w-full h-14 flex items-center justify-center gap-3 bg-gradient-to-r from-accent-pink to-accent-purple text-white rounded-xl font-semibold shadow-[0_4px_25px_rgba(232,121,199,0.35)] active:scale-95 hover:brightness-110 transition-all duration-200 cursor-pointer disabled:opacity-50"
          >
