...
export default function BottomNav({ currentScreen, onNavigate, unreadCount, inline }: BottomNavProps) {
  ...
  const navClass = inline
    ? 'app-bottom-bar flex-shrink-0 w-full bg-surface-elevated/90 backdrop-blur-xl border-t border-outline-variant/40'
    : 'app-bottom-bar fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-lg z-50 bg-surface-elevated/90 backdrop-blur-xl border-t border-outline-variant/40';
